...
<div style="margin: 10px 10px;">
		<ul class="b">
			...
			<security:authorize access="hasRole('ADMIN')">
				...
				Category</a></li>
				<li class="navLi"><a class="active" href="${pageContext.request.contextPath}/platform/create">Create
				Platform</a></li>
			</security:authorize>
			<li class="navLi"><a
	...
	<div id="loginbox" style="margin-top: 50px;"
		...
		<div class="panel panel-info">
			...
			<div class="panel-heading" style="background-color: #00adb5; color: #eeeeee;">
				<div class="panel-title">Add New Platform</div>
			</div>
			...
			<div style="padding-top: 30px; color: #393e46; font-size: medium; background-color: #eeeeee;" class="panel-body">
				<div class="container">
					...
					<form:form class="form-horizontal"
						action="${contextPath}/platform/create" method="post"
						...
						<div class="form-group">
							<div class="col-sm-offset-2 col-sm-5">
								<input type="submit" name="Submit" value="Post Platform"
