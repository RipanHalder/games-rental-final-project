...
<script type="text/javascript">
	function validate() {
		Date
		selectedDate = document.forms["bookingForm"]["returnDate"].value;
		Date
		currentDate = new Date();

		if (selectedDate < currentDate) {
			alert('Selected date is smaller than the current date.');
			return false;
		}
	}
</script>
...
<body>
	...
	<div style="margin: 10px 10px;">
		<ul class="b">
			...
			<li class="navLi"><a
				href="${pageContext.request.contextPath}/aboutme">About Me</a></li>
			<li class="navLi">
	...
	<div id="loginbox" style="margin-top: 50px;"
		...
		<div class="panel panel-info">
			...
			<div class="panel-heading"
				...
				<div class="panel-title">Add New Booking</div>
			</div>
			...
			<div
				...
				<div class="container">
					...
					<form:form class="form-horizontal"
						action="${contextPath}/booking/showBookingForm" method="post"
						name="bookingForm" onsubmit="return validateForm()">
						<div class="form-group">
							<label class="control-label col-sm-2">Return Date:</label>
							<div class="col-sm-5">
								<div style="margin-bottom: 25px" class="input-group">
									<span class="input-group-addon"><i
										class="glyphicon glyphicon-blackboard"></i></span> <input type="date"
										name="returnDate" id="returnDate" required="required" />
								</div>
							</div>
						</div>
						<div class="form-group">
							<div class="col-sm-offset-2 col-sm-5">
								<input type="submit" name="Submit"
									value="Calculate Total Amount" class="btn btn-primary"
